...
Nicht jeder Kampf wird mit Waffengewalt entschieden. Wie auch bei den Waffen gibt es für jeden sog. Elementarschaden einen besonderen Effekt, der beim Erzielen eines max. Würfelergebnis eintritt.
\begin{description}
...
\item[Säure]Für jeden proc, wird ein weiterer d6 gerollt und das Ergebnis zum Endschaden hinzugefügt. Jede weitere 6 bei diesem Zusatzschaden erzwingt einen weiteren Würfelwurf. Die Procgrenze kann durch die Qualität der Säure gesenkt werden.
\end{description}

...
\chapter{Effekte}
Es gibt drei Kategorien von Effekten:
\\Modifikationen, sowohl negativ als auch negativ.
\\Counter, welche bei Konkurrieren Proben Boni des anderen aufheben.
\\Block, welche dort genannten Effekte am applien hindert.
Bei allen Effekten gibt es eine Source und einen Value. Es gilt für einen Source-Typ jeweils nur die beiden Values mit dem größten Ausschlag(also negativ und positiv).
Um Counter und Block mit Mods abzugleichen, wird natürlich immer das Absolut genommen. 

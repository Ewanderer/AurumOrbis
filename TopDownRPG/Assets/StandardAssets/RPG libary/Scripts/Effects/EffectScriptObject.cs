...
public class EffectScriptObject {
	...
	void ProcessCommandToCreature(TCreature target,string[] CallParameter,Paramter[] Triggerparameter){
	
	}

	void ProcessCommandToEffect(TCreature target,string[] CallParameter,Paramter[] Triggerparameter){

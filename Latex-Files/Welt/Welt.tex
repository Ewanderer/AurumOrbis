...
\item[Ausfall]
Mit einem Schlachtruf an Aigis stürmt der Geweihte getragen von übernatürliche Stärke an die Seite von Schutzbedürftigen und erzeugt durch eine Energiewoge ein kurzen Moment der Ruhe, indem er alle Feinde die einen Stärkecheck nicht schaffen zurück wirft.
\end{description}
...
Wissen geht verloren und der Geweihte tut durch das neu entdecken solchen Wissens und die Verbreitung führt dem Geweihtem Energie zu.
...
\end{itemize}
\section{Priester}
Zwar kann jeder, der in seinem Blut den Segen eines Gottes trägt, ihm als Geweihter dienen, doch Priester widmen ihr gesamtes Leben den Weihen ihrer Religion. Im Gegensatz zu gewöhnlichen Geweihten, bietet einen Priester seinen Beistand basierend auf den 
Prinzipien seiner Religion gegen Bezahlung oder frei an. Prinzipiell kann ein Priester doch von seinem Geschäft leben. Priester von unliebsamen Religionen werden in der Regel auch Kultisten genannt.
\subsection{Voraussetzungen}
Volk: Jedes Gottgeschaffene, außer elfische
\subsection{Fertigkeiten}
Priester orientieren sich bei ihren Präferenzen an den Lehren ihrer Religion, siehe daher bei dem jeweiligen Gott.
\subsection{Stufen}
\begin{itemize}
\item Stufe 0: Zeichen der Weihe(Der Priester kann eindeutig seiner Religion zugeordnet werden, was ihm bei Verhandlungen über seine Dienste einen Vorteil einbringt);
\end{itemize}
\section{Gauner}
...
\subsection{Stufen}
\begin{itemize}
\item Stufe 0: Fokus(Verstecken, Mengen); Fokus(Feinmechanik, Fallen entschärfen)

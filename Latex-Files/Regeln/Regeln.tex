...
\chapter{Kampf}
In Kampfsituationen wird das Kampfgeschehen in Runden eingeteilt. Zu Beginn jeder Runde wird der sog. PAI bestimmt. PAI steht dabei für: Parade, Attacke und Initiative. Initiative wird im Programm einmalig bei Ausrüsten einer Waffe berechnet und ohne das zusätzliche Punkt darauf verteilt werden können. Diese Werte werden über den Grundwert von Waffe, Attacke-Nahkampf/Fernkampf, Parade-Basiswert. In einer Runde stehen einer Figur 2 Aktionen zur Verfügung. Zusätzlich hat jede Figur noch min. eine Freie Aktion, wobei z.B. das Verlieren von Konzentration nicht als solche gilt.

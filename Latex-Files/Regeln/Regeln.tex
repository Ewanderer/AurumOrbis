...
\\Kondition=Konstitution*10+Boni
...
\item[Nahkampfangriff]Parade des Ziels wird mit eigenem Angriff verglichen. Basierend auf der Differenz wird Schaden gerollt. Alternativ kann man seinen Angriff auf mehrere nebeneinander stehende Gegner aufteilen.
\item[Kampfmanöver]Ein Nahkampfangriff, an den eine konkurrierende Probe mit den Waffentalente, die durch die Differenz erleichtert wird und die beiden Waffentalente einschließt.
...
\begin{itemize}
\item Werden mehrere Waffen geführt erhält man einen Abzug auf Angriff und Parade von 4 und Initiative von 2.
\end{itemize} 

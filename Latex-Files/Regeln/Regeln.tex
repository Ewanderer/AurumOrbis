...
\\Die Formel zur Rangbestimmung auf Basis der Erfahrungspunkte ist:
\\$7X+e^{\frac{x}{10}}$
\\Neu Formel:$\frac{9x^{2}}{40}+7x$
...
\item[Dolch]
\item[Faustkampf]
\item[kleine Wurfwaffen]
\item[Wurfwaffen] Speere
\item[Schleudern]
\item[Hiebwaffen]
